<template>
    <div class="welcome-board">
        <div class="welcome-title">用户注册</div>
        ...
        <div class="btn-mt">
            <el-button class="btn-single" type="primary" @click="register()" plain>注册</el-button>
        </div>
        <div class="ft-tip">
            <span style="color: gray">已有账号？</span>
            <el-link class="link" type="primary" @click="router.push('/login')">立即登录</el-link>
        </div>
    </div>
</template>
