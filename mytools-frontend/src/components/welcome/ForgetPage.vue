<template>
    <div class="welcome-board" style="height: 314px;overflow: hidden">
        <div class="welcome-title">重置密码</div>
        ...
        <transition name="el-fade-in-linear" mode="out-in">
            <div v-if="active === 0" style="margin-bottom: 45px;">
                ...
                <div class="btn-mt">
                    <el-button class="btn-single" type="primary" @click="startReset()" plain>立即重置</el-button>
                </div>
                <div class="ft-tip">
                    <el-link class="link" type="primary" @click="router.push('/login')">返回</el-link>
                </div>
            </div>
        </transition>
        ...
        <transition name="el-fade-in-linear" mode="out-in">
            <div v-if="active === 1">
                ...
                <div class="btn-mt">
                    <el-button class="btn-single" type="primary" @click="doReset()" plain>确认重置</el-button>
                </div>
                <div class="ft-tip">
                    <el-link type="primary" class="link" @click="back()">返回上一步</el-link>
                </div>
            </div>
        </transition>
    </div>
